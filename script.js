        ...
        <div class="dateshower">
            <div class="my-4">
                <button type="button" id=${
                  item.id
                } onclick=editdata(this.id) class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#exampleModal2">
                     Edit Post
                 </button>
                   <button type="button" id=${
                     item.id
                   } onclick=deletedata(this.id) class="btn btn-dark">Delete Post</button>
                 </div>
        
        
                  <div >
                  ${item.text}: ${datetimerformatter(
...
// Function for editing the save post
      ...
      return `  <div class="row me-4 ms-4 my-4 p-3 border border-dark " >
        ...
        <div class="dateshower">
            <div class="my-4">
                <button type="button" id=${
                  item.id
                } onclick=editdata(this.id) class="btn btn-dark  my-2" data-bs-toggle="modal" data-bs-target="#exampleModal2">
                     Edit Post
                 </button>
                   <button type="button" id=${
                     item.id
                   } onclick=deletedata(this.id) class="btn btn-dark my-2">Delete Post</button>
                 </div>
